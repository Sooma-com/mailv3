...
$config['plugins'] = [ 'xcalendar', 'password', 'reset_password', 'username_login', 'sooma', 'subscriptions_option', 'nexus', 'nexus_storage', 'nexus_registered', 'managesieve', 'sooma_smime' ];
